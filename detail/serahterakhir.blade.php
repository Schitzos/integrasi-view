...
@section('title','Serah Terima Terakhir')
@section('content')
        ...
        <div class="page-head">
            <div class="container">
                <div class="page-title">
                    <h1>{{$data->nama_paket}}
                        <small>Serah Terima Terakhir</small>
                    </h1>
                </div>
            </div>
        </div>
            ...
            <div class="container">
                <div class="page-content-inner">
                    <div class="mt-content-body">
                        ...
                        <div class="row">
                            <div class="col-md-12 col-sm-12">
                                <div class="portlet light ">
                                    ...
                                    <form action="{{url('/terakhir')}}" role="form" method="POST" class="form-horizontal" enctype="multipart/form-data" >
                                        ...
                                        <div class="form-actions">
                                            <div class="row" align="center">
                                                <div class="col-md-12"> 
                                                    ...
                                                    {{-- <button type="submit" class="btn red-intense" target="_blank"><i class="fa fa-file-pdf-o"></i>&nbsp;Cetak</button> --}}
                                                </div>
                                            </div>
                                        </div>
                                    </form>
                        ...
                        <div class="row" align="center">
                            <div class="col-md-12"> 
                                <a class="btn red-intense" onclick="TambahTerakhir({{$data->id_paket}});"><i class="fa fa-file-pdf-o"></i> Unggah Serah Terima</a>
                                <a class="btn blue-sharp" href="{{URL::to('/terakhir/downloadfile/'.$data->id_paket )}}"><i class="fa fa-file-pdf-o"></i> Unduh Serah Terima</a>                              
                            </div>
                        </div>
                    </div>
                </div>
...
<div class="modal fade bs-modal-lg" id="TambahTerakhir" tabindex="-1" role="dialog" aria-hidden="true">
    <div class="modal-dialog modal-lg">
        <div class="modal-content">
            <form action="{{ url('terakhir/uplod') }}" role="form" method="POST" class="form-horizontal" enctype="multipart/form-data" >
                <input type="hidden" name="_token" value="{{ csrf_token() }}">
                <input type="hidden" name="idpaket" id="idpaket" value="{{$data->id_paket}}">
                <div class="modal-header">
                    <button type="button" class="close" data-dismiss="modal" aria-hidden="true"></button>
                    <h4 class="modal-title">Unggah Serah Terima Terakhir</h4>
                </div>

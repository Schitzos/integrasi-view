@extends('layouts.app')
@section('title', 'Tambah Honor Non PNS')
@section('content')
<div class="page-content">
    <form action="{{ url('pns') }}" role="form" method="POST" class="form-horizontal" enctype="multipart/form-data">
                            ...
                            <div class="row">
                                <div class="col-md-7">
                                    <div class="form-group">
                                        ...
                                        <div class="col-md-6">
                                            <input type="text" id="Tgl_PNS" name="Tgl_PNS" class="form-control"/>
                                        </div>
                                    </div>
                                </div>
                            </div>

@extends('layouts.app')
@section('title','Honor Non PNS')
@section('content')
<div class="page-content">
    <div class="row">
        <div class="col-md-12" align="right">
            <a  class="btn blue-sharp btn-outline" data-container="body" href="{{ URL::to('/pns/create') }}">
            ...
            <div class="portlet light bordered">
                <div class="portlet-title">
                    <div class="caption font-dark">
                        ...
                        <span class="caption-subject bold uppercase">Honor Non PNS</span>
                    </div>
                    <div class="tools"></div>
                </div>
                    ...
                    <table class="table table-striped table-bordered table-hover" id="lembur">
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td style="text-align:center;">
                                    <a class="btn tooltips btn-xs blue-sharp btn-outline" data-container="body" data-placement="top" data-original-title="Cetak Honor" href="{{ URL::to('pns/' . $dt->kd_honor .'/cetak') }}" target="_blank">
                                    <i class="fa fa-print"></i>
                                    </a>
                                    <a class="btn tooltips btn-xs yellow-saffron btn-outline" data-container="body" data-placement="top" data-original-title="Ubah Honor" data-toggle="modal" href="{{ URL::to('pns/' . $dt->kd_honor .'/edit') }}">
                                    <i class="fa fa-edit"></i>
                                    </a>&nbsp;&nbsp;
                                    <a href="{{ URL::to('/pns/delete/'.$dt->kd_honor) }}" class="btn red-intense btn-xs btn-outline" data-placement="left" data-singleton="true" data-original-title="Hapus Honor ?" data-toggle="confirmation" data-btn-ok-label="Ya" data-btn-cancel-label="Tidak"  data-popout="true">

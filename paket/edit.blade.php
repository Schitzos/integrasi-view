...
<form class="form-horizontal" action="{{ url('home/update') }}" id="submit_form" method="POST">
<input type="hidden" name="_token" value="{{ csrf_token() }}">
<input type="hidden" name="idpaket" value="{{ $data->id_paket }}">
<input type="hidden" name="idkonsultan" value="{{ $data->id_konsultan }}">
<input type="hidden" name="idkontraktor" value="{{ $data->id_kontraktor }}">
<div class="form-body">
...
@if($k->id_kegiatan==$data->id_kegiatan)
...
@foreach($dpa as $d)
@if($d->id_dpa==$data->id_dpa)
<option value="{{$d->id_dpa}}" selected>{{$d->uraian}}</option>
@else
<option value="{{$d->id_dpa}}">{{ $d->uraian}}</option>
@endif
@endforeach
</select>
</div>
...
@if($k->nip_pegawai==$data->kordinator_paket)
<option value="{{$k->nip_pegawai}}" selected>{{$k->nama_pegawai}}</option>
@else
...
<div class="col-md-8">
<input  type="text" id="Nomor_Kontrak" name="Nomor_Kontrak" class="form-control" value="{{ $data->nomor_kontrak }}">
</div>
</div>
</div>
<div class="col-md-6">
...
<div class="col-md-8">
<input type="text" id="Tgl_SPMK" name="Tgl_SPMK" class="form-control" value="{{  date('d F Y',strtotime($data->tgl_spmk)) }}">
</div>
</div>
</div>
</div>
...
<div class="col-md-8">
<input  type="text" id="Nomor_SPMK" name="Nomor_SPMK" class="form-control" value="{{ $data->no_spmk }}">
</div>
</div>
</div>
<div class="col-md-6">
...
<input type="text" class="form-control" name="from" id="Tgl_Kontrak1" value="{{ date('m/d/Y',strtotime($data->tgl_mulai)) }}">
<span class="input-group-addon"> s/d </span>
<input type="text" class="form-control" name="to" id="Tgl_Kontrak2" value="{{ date('m/d/Y',strtotime($data->tgl_selesai)) }}">
</div>                                                
</div>
</div>
</div>
...
<div class="col-md-8">
<input  type="text" id="Nilai_Kontrak" name="Nilai_Kontrak" class="form-control autonumber" data-a-sign="Rp " value="{{ $data->nilai_paket }}">
...
<div class="col-md-8">
<input  type="text" id="Tahun_Anggaran" name="Tahun_Anggaran" class="form-control"  value="{{ $data->periode }}">
</div>
</div>
</div>
</div>  
...
<div class="col-md-6">
<div class="form-group">
<label for="Ketua_PPHP" class="col-md-4 control-label">Ketua PPHP<span class="required"> * </span></label>
<div class="col-md-8">
...
<div class="col-md-6">
<div class="form-group">
<label for="Kecamatan_Paket" class="col-md-4 control-label">Kecamatan<span class="required"> * </span></label>
<div class="col-md-8">
...
<div class="col-md-6">
<div class="form-group">
<label for="Desa_Paket" class="col-md-4 control-label">Desa<span class="required"> * </span></label>
<div class="col-md-8">
...
<div class="col-md-6">
<div class="form-group">
<label for="Latitude" class="col-md-4 control-label">Latitude<span class="required"> * </span></label>
<div class="col-md-8">
...
<div class="col-md-6">
<div class="form-group">
<label for="Longitude" class="col-md-4 control-label">Longitude<span class="required"> * </span></label>
<div class="col-md-8">
...
<div class="col-md-6">
<div class="form-group">
<label for="Kontraktor_Paket" class="col-md-4 control-label">Kontraktor<span class="required"> * </span></label>
<div class="col-md-8">
...
<div class="col-md-6">
<div class="form-group">
<label for="Konsultan_Paket" class="col-md-4 control-label">Konsultan<span class="required"> * </span></label>
<div class="col-md-8">

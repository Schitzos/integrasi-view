@extends('layouts.app')
@section('title', 'Ubah Honor Rapat')
@section('content')
<div class="page-content">
    <form action="{{ url('rapat/update') }}" role="form" method="POST" class="form-horizontal" enctype="multipart/form-data">
                    ...
                    <div class="portlet-body form">
                        <div class="form-body">
                            ...
                            <div class="row">
                                <div class="col-md-7">
                                    <div class="form-group">
                                        <label for="Tgl_Rapat" class="control-label col-md-2" style="color:#555555;">Tanggal</label>
                                        <div class="col-md-6">
                                            <input type="text" id="Tgl_Rapat" name="Tgl_Rapat" class="form-control" value="{{date('d F Y',strtotime($data->tgl_cetak_honor))}}" />
                                        </div>
                                    </div>
                                </div>
                            </div>
                        ...
                        <div class="form-actions">
                            <div class="row" align="center">
                                <div class="col-md-12">                                    
                                    ...
                                    <a class="btn red-intense" href="{{ URL::to('/rapat') }}">

@extends('layouts.app')
@section('title', 'Tambah Honor Rapat')
@section('content')
<div class="page-content">
    <form action="{{ url('rapat') }}" role="form" method="POST" class="form-horizontal" enctype="multipart/form-data">
                            ...
                            <div class="row">
                                <div class="col-md-7">
                                    <div class="form-group">
                                        ...
                                        <div class="col-md-6">
                                            <input type="text" id="Tgl_Rapat" name="Tgl_Rapat" class="form-control"/>
                                        </div>
                                    </div>
                                </div>
                            </div>

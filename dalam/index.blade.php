...
<a  class="btn blue-madison" data-container="body" href="{{ URL::to('/dalam/create') }}">
<i class="fa fa-plus-square"></i>&nbsp;Tambah Dalam Daerah
</a>
</div>
<div class="actions">
<div class="btn-group">
...
<a class="btn tooltips btn-xs blue-sharp " data-container="body" data-placement="top" data-original-title="Cetak" href="{{ URL::to('dalam/' . $dt->id_perjalanan .'/cetak') }}" target="_blank">
<i class="fa fa-print"></i>
</a>&nbsp;&nbsp;
<a class="btn tooltips btn-xs yellow-casablanca " data-container="body" data-placement="top" data-original-title="Ubah Perjalanan Dinas" href="{{ URL::to('/dalam/'.$dt->id_perjalanan.'/edit') }}">
<i class="fa fa-edit"></i>
</a>&nbsp;&nbsp;
<a class="btn tooltips btn-xs btn-success" data-container="body" data-placement="top" data-original-title="Ajukan Perjalanan Dinas" href="#" onclick="TambahKendali(`{{ $dt->id_kegiatan }}`,{{ $dt->id_perjalanan }},'/dalam');">
<i class="fa fa-check"></i>
</a>&nbsp;&nbsp;
<a href="{{ URL::to('/dalam/delete/'.$dt->id_perjalanan) }}" class="btn grey-gallery btn-xs " data-placement="left" data-singleton="true" data-original-title="Hapus Perjalanan ?" data-toggle="confirmation" data-btn-ok-label="Ya" data-btn-cancel-label="Tidak"  data-popout="true">

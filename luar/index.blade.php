...
<a  class="btn blue-madison" data-container="body" href="{{ URL::to('/luar/create') }}">
<i class="fa fa-plus-square"></i>&nbsp;Tambah Luar Daerah
</a>
</div>
<div class="actions">
<div class="btn-group">
...
<a class="btn tooltips btn-xs blue-sharp" data-container="body" data-placement="top" data-original-title="Cetak" href="{{ URL::to('luar/' . $dt->id_perjalanan .'/cetak') }}" target="_blank">
<i class="fa fa-print"></i>
</a>&nbsp;&nbsp;
<a class="btn tooltips btn-xs yellow-casablanca" data-container="body" data-placement="top" data-original-title="Ubah Perjalanan Dinas" href="{{ URL::to('/luar/'.$dt->id_perjalanan.'/edit') }}">
<i class="fa fa-edit"></i>
</a>&nbsp;&nbsp;
<a class="btn tooltips btn-xs btn-success" data-container="body" data-placement="top" data-original-title="Ajukan Perjalanan Dinas" href="#" onclick="TambahKendali(`{{ $dt->id_kegiatan }}`,{{ $dt->id_perjalanan }},'/luar');">
<i class="fa fa-check"></i>
</a>&nbsp;&nbsp;
<a href="{{ URL::to('/luar/delete/'.$dt->id_perjalanan) }}" class="btn grey-gallery btn-xs" data-placement="left" data-singleton="true" data-original-title="Hapus Perjalanan ?" data-toggle="confirmation" data-btn-ok-label="Ya" data-btn-cancel-label="Tidak"  data-popout="true">
<i class="fa fa-trash-o"></i>
</a>
</td>
</tr>
@elseif ($dt->sts_kendali==0)
<tr>
<td style="text-align:center;">{{$i}}</td>
<td style="text-align:left;">{{$dt->nomor_perjalanan}}</td>
<td style="text-align:right;">{{$dt->nama_pegawai}}</td>

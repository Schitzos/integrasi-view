@extends('layouts.app')
@section('title', 'Tambah Agustus')
@section('content')
<div class="page-content">
    <form action="{{ url('lembur/agustus') }}" role="form" method="POST" class="form-horizontal" enctype="multipart/form-data">
            ...
            <div class="col-md-12">
                <div class="portlet light bordered">
                    <div class="portlet-title"><div class="caption"><i class="icon-user font-dark"></i>Uang Lembur &amp; Absensi</div>
                        <a  class="btn blue-sharp btn-outline pull-right" data-container="body" onClick="tambahlembur('DinamikInput','agustus');">

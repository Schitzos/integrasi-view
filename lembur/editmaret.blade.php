@extends('layouts.app')
@section('title', 'Ubah Maret')
@section('content')
<div class="page-content">
    <form action="{{ url('lembur/maret/update') }}" role="form" method="POST" class="form-horizontal" enctype="multipart/form-data">
        <input type="hidden" name="_token" value="{{ csrf_token() }}"/>
        <input type="hidden" id="IdLembur" name="IdLembur" value="{{$data->kd_lembur}}"/>
        <input type="hidden" id="IdBulan" name="IdBulan" value="maret"/>
            ...
            <div class="col-md-12">
                <div class="portlet light bordered">
                    <div class="portlet-title"><div class="caption"><i class="icon-user font-dark"></i>Uang Lembur &amp; Absensi</div>
                        <a  class="btn blue-sharp btn-outline pull-right" data-container="body" onClick="tambahlemburubah('DinamikInputUbah','maret');">
                        ...
                        <div class="form-actions">
                            <div class="row" align="center">
                                <div class="col-md-12">                                    
                                    ...
                                    <a class="btn red-intense" href="{{ URL::to('/lembur/maret') }}">

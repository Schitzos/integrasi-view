@extends('layouts.app')
@section('title','Lembur September')
@section('content')
<div class="page-content">
    <div class="row">
        <div class="col-md-12" align="right">
            <a  class="btn blue-sharp btn-outline" data-container="body" href="{{ URL::to('/lembur/september/create') }}">
            ...
            <div class="portlet light bordered">
                <div class="portlet-title">
                    <div class="caption font-dark">
                        ...
                        <span class="caption-subject bold uppercase">September</span>
                    </div>
                    <div class="tools"></div>
                </div>
                    ...
                    <table class="table table-striped table-bordered table-hover" id="lembur">
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td style="text-align:center;">
                                    <a class="btn tooltips btn-xs blue-sharp btn-outline" data-container="body" data-placement="top" data-original-title="Cetak Surat Perintah &amp; Hasil Lembur" href="{{ URL::to('lembur/september/' . $dt->kd_lembur .'/cetak') }}" target="_blank">
                                    <i class="fa fa-print"></i>
                                    </a>&nbsp;&nbsp;
                                    <a class="btn tooltips btn-xs green-meadow btn-outline" data-container="body" data-placement="top" data-original-title="Cetak Uang &amp; Absensi Lembur" href="{{ URL::to('lembur/september/' . $dt->kd_lembur .'/cetakmiring') }}" target="_blank">
                                    <i class="fa fa-print"></i>
                                    </a>&nbsp;&nbsp;
                                    <a class="btn tooltips btn-xs yellow-saffron btn-outline" data-container="body" data-placement="top" data-original-title="Ubah Lembur" data-toggle="modal" href="{{ URL::to('lembur/september/' . $dt->kd_lembur .'/edit') }}">
                                    <i class="fa fa-edit"></i>
                                    </a>&nbsp;&nbsp;
                                    <a href="{{ URL::to('/lembur/september/delete/'.$dt->kd_lembur) }}" class="btn red-intense btn-xs btn-outline" data-placement="left" data-singleton="true" data-original-title="Hapus Lembur ?" data-toggle="confirmation" data-btn-ok-label="Ya" data-btn-cancel-label="Tidak"  data-popout="true">

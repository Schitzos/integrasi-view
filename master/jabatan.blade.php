...
<h1>Jabatan Dinas
<small>Daftar Jabatan Dinas</small>
</h1>
</div>
</div>
</div>
...
<button class="btn blue-madison" onclick="TambahJabatan();"><i class="fa fa-plus-square"></i>&nbsp;Tambah Jabatan</button>
</div>
<div class="actions">
<div class="btn-group">
...
<td  style="text-align:left;vertical-align:middle;">{{$dt->nama_jabatan}}</td>
<td  style="text-align:left;vertical-align:middle;">{{$dt->keterangan_jabatan}}</td>
<td  style="text-align:center;vertical-align:middle;">
<button class="btn tooltips yellow-casablanca btn-xs" title="Ubah Jabatan" onclick="UbahJabatan({{$dt->id_jabatan}});" ><i class="fa fa-edit"></i></button>
<a href="{{ URL::to('/jabatan/delete/' . $dt->id_jabatan) }}" class="btn grey-gallery btn-xs" data-placement="left" data-singleton="true" data-original-title="Hapus Jabatan" data-toggle="confirmation" data-btn-ok-label="Ya" data-btn-cancel-label="Tidak"  data-popout="true">
...
<form action="{{ url('jabatan') }}" role="form" method="POST" class="form-horizontal" enctype="multipart/form-data">
...
<div class="modal-body">
<form action="{{ url('jabatan/update') }}" role="form" method="POST" class="form-horizontal" enctype="multipart/form-data">
<input type="hidden" name="_token" value="{{ csrf_token() }}">

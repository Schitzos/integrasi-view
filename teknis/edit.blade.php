@extends('layouts.app')
@section('title', 'Ubah Honor Pelaksana Teknis')
@section('content')
<div class="page-content">
    <form action="{{ url('teknis/update') }}" role="form" method="POST" class="form-horizontal" enctype="multipart/form-data">
                            ...
                            <div class="row">
                                <div class="col-md-7">
                                    <div class="form-group">
                                        ...
                                        <div class="col-md-6">
                                            <input type="text" id="Tgl_Teknis" name="Tgl_Teknis" class="form-control" value="{{date('d F Y',strtotime($data->tgl_cetak_honor))}}" />
                                        </div>
                                    </div>
                                </div>
                            </div>

...
<form action="{{ url('bawean') }}" role="form" method="POST" class="form-horizontal" enctype="multipart/form-data">
...
<div class="row">
    ...
    <div class="portlet-body">
        <div class="col-md-12">
            <a style="color:green; float: right" class="btn icon-plus" title="tambah Akomodasi" onclick="tambahAko();"></a>
            <a style="color:red; float: right" class="btn icon-trash" id="hpsAko" title="hapus Akomodasi" onclick="hapusAko();"></a>        
        </div>
        <div id="bodinya">
            <div class="form-group" id="sesiAko1">
                <input type="hidden" name="jmlAko" id="jmlAko" value="1">
                <div class="col-md-4">
                    <label for="akojumlah1" class="control-label col-md-2" style="color:#555555;">Jumlah</label>
                    <div class="col-md-10">
                    <input type="text" id="akojumlah1"  name="akojumlah1" class="form-control autonumber"/>
                    </div>
                </div>
                <div class="col-md-4">
                    <label for="akoharga1" class="control-label col-md-2" style="color:#555555;">Harga</label>
                    <div class="col-md-10">
                    <input type="text" id="akoharga1"  name="akoharga1" data-a-sign="Rp " class="form-control autonumber"/>
                    <input type="hidden" id="hargaAko1" name="hargaAko1"/>
                    </div>
                </div>
                <div class="col-md-4">
                    <label for="akohari1" class="control-label col-md-2" style="color:#555555;">Hari</label>
                    <div class="col-md-10">
                    <input type="text" id="akohari1"  name="akohari1" class="form-control autonumber"/>
                    </div>
                </div>
            </div>
        </div>
...
<a class="btn red-intense" href="{{ URL::to('/bawean') }}">
